...
def main(args):
    ...
    if args.mri_to_ct:
        train_dataset = NpyDataset(args.mir_image_folder_train, args.ct_image_folder_train, transform=transform_train)
    else:
        train_dataset = NpyDataset(args.ct_image_folder_train, args.mir_image_folder_train, transform=transform_train)
    ...
    for epoch in range(args.epochs):
        ...
        # print(epoch)
        item = 0
        for x_ct, z_mri in train_loader:
            item += 1
            ...
            model_kwargs = dict(y2=x_ct_2, w=weight)
